          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
              <button
                ...
                className="px-4 md:px-4 py-2.5 md:py-3 rounded-md border border-dark dark:border-white bg-transparent text-dark dark:text-white hover:bg-dark dark:hover:bg-white hover:text-white dark:hover:text-dark transition-colors duration-300  md:text-base font-medium whitespace-nowrap"
              >
                {t('mandatoryOnly')}
              </button>
              <button
                onClick={() => handleAccept('all')}
                className="px-4 md:px-4 py-2.5 md:py-3 rounded-md bg-primary text-white hover:bg-primary/90 transition-colors duration-300  md:text-base font-medium whitespace-nowrap"
              >
                {t('acceptAll')}
              </button>
            </div>
