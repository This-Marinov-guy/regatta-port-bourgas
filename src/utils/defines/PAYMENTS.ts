// Client-readable mirror of the server-side MYPOS_DISABLED kill-switch.
// MYPOS_DISABLED is server-only, so we expose a NEXT_PUBLIC_ copy that Next.js
// inlines into the client bundle. Keep NEXT_PUBLIC_MYPOS_DISABLED in sync with
// MYPOS_DISABLED in your env files.
export const MYPOS_DISABLED =
